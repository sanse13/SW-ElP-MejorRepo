...
<body>
  ...
  <section class="main" id="s1">
    <form id='fquestion' name='fquestion' action=’AddQuestion.php’ method="GET">
      ...
      <input type="text" size="50" id="pregunta" name="pregunta" minlength="10" required><br><br>
      ...
      <input type="text" size="50" id="resIncorrecta1" name="resIncorrecta1" required><br><br>

      <label for="resIncorrecta2"> Respuesta Incorrecta:</label>
      <input type="text" size="50"id="resIncorrecta2" name="resIncorrecta2" required><br><br>

      <label for="resIncorrecta1"> Respuesta Incorrecta: </label>
      <input type="text" size="50" id="resIncorrecta3" name="resIncorrecta3" required><br><br>

      <label for="tema"> Tema: </label>
      <input type="text" size="50" id="tema" name="tema" required><br><br>
